export default function JustSticky() {
  return (
    <div className="w-3/4 mr-auto">
      <EventsContainer>
        <EventHeading date={new Date("2025-05-13")} />
        <EventCard />
        <EventCard />
      </EventsContainer>
      <EventsContainer>
        <EventHeading date={new Date("2025-05-14")} />
        <EventCard />
        <EventCard />
        <EventCard />
        <EventCard />
      ...
      <EventsContainer>
        <EventHeading date={new Date("2025-05-15")} />
        <EventCard />
        <EventCard />
        <EventCard />
        <EventCard />
...
export function EventHeading({ date }: { date: Date }) {
  const day = date.toLocaleDateString("en-US", { weekday: "long" })
  const month = date.toLocaleDateString("en-US", { month: "long" })
  const dayOfMonth = date.toLocaleDateString("en-US", { day: "numeric" })

  return (
    <div className="sticky -top-1 pt-4 w-fit">
