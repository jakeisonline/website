---
title: There is no harm in overcommunicating pending state in your UI
...
Visually showing pending state is great, but you're not thinking about anyone with a disability that might make visual comprehension difficult.
