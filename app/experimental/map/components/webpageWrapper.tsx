...
export default function WebpageWrapper() {
  ...
  const handleIsLoadStart = () => setIsLoading(true)

  return (
    <div className="overflow-hidden flex flex-col h-screen z-50">
      <div className="w-screen h-16 bg-white border-b-2 border-zinc-400 flex justify-between items-center px-3">
        <button
