...
| ------------------ | ------ | --------------------------------------------------------------------- |
| `minRange`         | number | The minumum number a user can select.                                 |
| `maxRange`         | number | The maximum number a user can select.                                 |
...
| Prop   | Type              | Description                                                  |
| ------ | ----------------- | ------------------------------------------------------------ |
| `type` | `"low" \| "high"` | The type of the grabber. Must be either `"low"` or `"high"`. |
