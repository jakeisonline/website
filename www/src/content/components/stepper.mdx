...
description: "A fully interactive, accessible, user interface element that allows users to increment or decrement a value. It is commonly used for inputting numerical values, such as quantities or prices."
slug: "stepper"
component: "stepper"
...
<ExampleComponent name="stepper-shift" client:visible />
...
<ExampleComponent name="stepper-collapse" client:visible />
